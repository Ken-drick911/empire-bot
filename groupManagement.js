...
📌 *Moderation:*
.kick @user – Remove member (up to 10)
.warn @user – Warn (3 warns → kick)
.mute @user 30m – Mute with timer (m/h/d)
.unmute @user – Unmute
.promote @user – Make admin
.demote @user – Remove admin

🛡️ *Protection:*
.antilink off/whatsapp/all – Link filter
.antispam on/off – Spam protection

👋 *Welcome/Leave:*
.welcome on/off – Toggle welcome
.leave on/off – Toggle leave
.setwelcome "msg" – Custom welcome (use @)
.setleave "msg" – Custom leave (use @)

📢 *Tags:*
.tagall "msg" – Tag everyone
.tagadmins "msg" – Tag admins
.hidetag "msg" – Tag invisibly
